...
class QNN(nn.Module):
    ...
    def __init__(self, in_features, out_features, variational_layers=1, higher_order=False, optimizer=DefaultOptimizer()):
        ...
        self.peo = circuit_optimization(in_features, variational_layers, tn, optimizer, self.com)
...
'''Embedds classical vectors in the quantum Hilbert space and takes their inner product'''
class InnerProduct(nn.Module):
    ...
    def __init__(self, n_qubits, n_layers, optimizer=DefaultOptimizer()):
        ...
        '''peo is the tensor network contraction order'''
        self.peo = circuit_optimization(n_qubits, n_layers, tn, optimizer, self.com)
